...
REM
REM Generated by Vivado on Thu Jul 24 10:18:11 +0530 2025
...
echo "xvlog --incr --relax -prj SLAVE_tb_vlog.prj"
call xvlog  --incr --relax -prj SLAVE_tb_vlog.prj -log xvlog.log
